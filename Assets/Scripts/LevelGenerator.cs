...
public class LevelGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach(GameObject outline in generatedOutlines){
            ...
            if (includeShop){
                ...
                Instantiate(centerShop, outline.transform.position, transform.rotation).room = outline.GetComponent<Room>();
            ...
            if (includeGunRoom){
                ...
                Instantiate(centerGunRoom, outline.transform.position, transform.rotation).room = outline.GetComponent<Room>();
    ...
    public void CreateRoomOutline(Vector3 roomPosition){
        ...
        switch(directionCount){
            case 0:
                Debug.LogError("Ups! Found no room Exists.");
                break;
            case 1:
                if (roomAbove){
